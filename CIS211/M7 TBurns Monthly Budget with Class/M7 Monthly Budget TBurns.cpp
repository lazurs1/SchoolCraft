...
int main()
{
	...
	// Instantiate class
	GetandDisplay display1;
	display1.displayLogo(screen);
	display1.displayInitialData(screen);
	display1.displayPrevInfo(screen, mBudwithNums);
	display1.userInput(screen, mBudUserNums, mBudwithNums);
